...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.318Z
...
class UserRecordingsAPI {
	 ...
	 * @param {boolean} [query.async] -  When set to true, api will return 202 response until the recording is ready for download
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/userrecordings/{recordingId}/media" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @deprecated
	 */
	getUserrecordingMedia(recordingId, query) {
		const endpointPath = "/api/v2/userrecordings/{recordingId}/media";
		...
		if (query !== null) {
			...
			if ("async" in query && this.#checkJSONSchemaType(query["async"], "boolean") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "async", "boolean");
			}
		}
