...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.576Z
 ...
 * @property {boolean} [allowMicrophone] - whether or not agent microphone is allowed
 ...
 * @property {number} [sessionDurationSeconds] - The guest session duration settings for messenger conversations
 */
 ...
 * @property {string} [language] - Language of localized labels in homescreen app (eg. en-us, de-de) and push notification
 * @property {LocalizedLabels[]} [localizedLabels] - Contains localized labels used in messenger apps and push notification. PushNotificationTitle and PushNotificationBody are required when notifications are enabled.
 */
 
/**
 * @typedef {object} DeploymentIdentityResolutionConfig
 ...
 * @property {IdentityResolutionAutomergeConfig} [automerge] - Whether automerging of contacts should be enabled for each channel.
...
/**
 * @typedef {object} IdentityResolutionAutomergeConfig
 * @property {boolean} [authenticatedWebMessaging] - Whether automerging is enabled for Authenticated Webmessaging conversations in this channel.
 */
 ...
 * @property {string} [ipAddress] - IP address or CIDR range to filter (e.g. '192.168.1.0/24').
 * @property {string} [name] - Descriptive name for the IP address filter.
 */
 ...
 * @property {string[]} [excludedQueryParameters] - (deprecated) List of parameters to be excluded from the query string.
 * @property {boolean} [shouldKeepUrlFragment] - (deprecated) Whether or not to keep the URL fragment.
 * @property {string[]} [searchQueryParameters] - (deprecated) List of query parameters used for search (e.g. 'q').
 ...
 * @property {TrackingSettings} [trackingSettings] - Configuration settings for tracking behavior and filtering
 */
 ...
 * @property {string} [key] - Contains localized label key used in messenger homescreen and push notification. PushNotificationTitle and PushNotificationBody keys are required when notifications are enabled.
 * @property {string} [value] - Contains localized label value used in messenger homescreen and push notification
 */
 ...
 * @property {boolean} [enabled] - The toggle to enable or disable notifications. When enabled, PushNotificationTitle and PushNotificationBody localization keys are required.
 * @property {string} [notificationContentType] - The notification content type settings for messenger
 */
...
/**
 * @typedef {object} PushIntegration
 * @property {string} [id] - The mobile push integration id associated with the deployment
 * @property {string} [provider] - The integration provider associated with the deployment
 */
 ...
 * @property {string[]} [searchQueryParameters] - List of query parameters used for search (e.g. 'query').
 * @property {IpFilter[]} [ipFilters] - IP address filtering configuration for tracking restrictions.
 */
 ...
 * @property {boolean} [allowMicrophone] - whether or not user microphone is allowed
 */
 ...
 * @property {PushIntegration[]} [pushIntegrations] - The push integration objects associated with the deployment
 ...
 * @property {string} [idToken] - The implicit id_token to be sent to the authentication server during the token request.
 Refer to https://openid.net/specs/openid-connect-core-1_0.html#AuthRequest
...
class WebDeploymentsAPI {
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/webdeployments/deployments/{deploymentId}/identityresolution" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWebdeploymentsDeploymentIdentityresolution(deploymentId) {
		const endpointPath = "/api/v2/webdeployments/deployments/{deploymentId}/identityresolution";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} deploymentId - The deployment ID
	 * @param {DeploymentIdentityResolutionConfig} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/webdeployments/deployments/{deploymentId}/identityresolution" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
