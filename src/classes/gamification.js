...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.555Z
...
class GamificationAPI {
	 ...
	 * @param {string} [query.reportsTo] -  The reportsTo used by ABAC policies.
	...
	getGamificationInsightsMembers(query) {
		...
		if ("reportsTo" in query && this.#checkJSONSchemaType(query["reportsTo"], "string") === false) {
			throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "reportsTo", "string");
		}
	 ...
	 * @param {number} [query.pageSize] -  Page size
	 * @param {number} [query.pageNumber] -  Page number
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/gamification/insights/managers" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_MISSING} If a required query string parameter is missing.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getGamificationInsightsManagers(query) {
		const endpointPath = "/api/v2/gamification/insights/managers";
		const endpointMethod = "GET";
