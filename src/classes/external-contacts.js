...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.547Z
...
/**
 * @typedef {object} BulkContactsEnrichRequest
 * @property {ContactEnrichRequest[]} [entities]
 */
...
/**
 * @typedef {object} BulkOrganizationsEnrichRequest
 * @property {ExternalOrganizationEnrichRequest[]} [entities]
 */
...
/**
 * @typedef {object} ContactEnrichOptions
 * @property {boolean} [promote] - If true, any matched contact will have its type updated to Curated. If false, any matched contact will keep its original type in the operation.
 */
 
/**
 * @typedef {object} ContactEnrichRequest
 * @property {string} [id] - A user-specified tracker string, only useful in the Bulk-Enrich API. If one Bulk-Enrich operation in a request fails, the requested operation will be repeated in the Bulk API response, including this id field, allowing associating of request and response operations.
 * @property {WritableStarrableDivision} [division] - The division to which this entity belongs.
 * @property {ContactIdentifier[]} matchingIdentifiers - An ordered list of one or more Identifiers which might each be claimed by a Contact. `action` describes what to do with any possibly matching Contacts. Identifier lookups will occur in the order specified here.
 * @property {string} action - The action that should be taken based on any Contacts found by `matchingIdentifiers`.
 * @property {ExternalContact} [contact] - Data to be added, either as an update to an existing Contact or the body of a new Contact. Omitting a field in this contract means that it will be treated as null in the `fieldRules` logic.
 * @property {EnrichFieldRules} [fieldRules] - Logic describing how to combine data from the submitted request with data found in the database.
 * @property {ContactEnrichOptions} [options] - Additional options modifying the behavior of the API operation.
 */
 ...
 * @property {WritableStarrableDivision} [division] - The division to import into
 */
 ...
 * @property {WritableStarrableDivision} [division] - Division for the csv job
 */
...
/**
 * @typedef {object} ExternalOrganizationEnrichRequest
 * @property {string} [id] - A user-specified tracker string, only useful in the Bulk-Enrich API. If one Bulk-Enrich operation in a request fails, the requested operation will be repeated in the Bulk API response, including this id field, allowing associating request and response operations.
 * @property {WritableStarrableDivision} [division] - The division to which this entity belongs.
 * @property {ExternalOrganizationIdentifier[]} [matchingIdentifiers] - An ordered list of one or more Identifiers which might each be claimed by an External Organization. `action` describes what to do with any possibly matching External Organization. Identifier lookups will occur in the order specified here.
 * @property {string} [action] - The action that should be taken based on any External Organization found by `matchingIdentifiers`.
 * @property {ExternalOrganization} [externalOrganization] - Data to be added, either as an update to an existing External Organization or the body of a new External Organization. Omitting a field in this contract means that it will be treated as null in the `fieldRules` logic.
 * @property {EnrichFieldRules} [fieldRules] - Logic describing how to combine data from the submitted request with data found in the database.
 * @property {string} [selfUri] - The URI for this object
 */
...
/**
 * @typedef {object} ExternalOrganizationIdentifierClaimRequest
 * @property {string} operation - The operation to perform claim/release
 * @property {ExternalOrganizationIdentifier} identifier - The identifier that should be claimed/released from an external org
 */
...
/**
 * @typedef {object} MergeContactsRequest
 * @property {string[]} contactIds - The IDs of all contacts involved in the merge operation (must be between 2 and 25).
 * @property {ExternalContact} [valueOverride] - Override data to set for specific Contact fields after a merge. Any null fields in `valueOverride` will not replace existing data.
 */
...
/**
 * @typedef {object} SegmentAssignments
 * @property {SegmentForAssignment[]} segments - The segments to be assigned.
 */
 
/**
 * @typedef {object} SegmentForAssignment
 * @property {string} id - The ID of the segment to be assigned.
 */
 
/**
 * @typedef {object} SegmentForUnassignment
 * @property {string} id - The ID of the segment to be unassigned.
 */
 
/**
 * @typedef {object} SegmentUnassignments
 * @property {SegmentForUnassignment[]} segments - The segments to be unassigned.
 */
...
/**
 * @typedef {object} UpdateSegmentAssignmentRequest
 * @property {SegmentAssignments} [assign] - The segment assignments to apply.
 * @property {SegmentUnassignments} [unassign] - The segment unassignments to apply.
 */
...
class ExternalContactsAPI {
	 ...
	 * @async
	 * @param {BulkIdsRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/bulk/contacts/divisionviews" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsBulkContactsDivisionviews(body) {
		const endpointPath = "/api/v2/externalcontacts/bulk/contacts/divisionviews";
		const endpointMethod = "POST";
	 ...
	 * @param {boolean} [query.dryRun] -  If true, the request will not make any modifications, but will show you what the end result *would* be.
	 * @param {BulkContactsEnrichRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/bulk/contacts/enrich" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsBulkContactsEnrich(query, body) {
		const endpointPath = "/api/v2/externalcontacts/bulk/contacts/enrich";
		const endpointMethod = "POST";
		...
		if (query !== null) {
			if ("dryRun" in query && this.#checkJSONSchemaType(query["dryRun"], "boolean") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "dryRun", "boolean");
			}
		}
	 ...
	 * @async
	 * @param {BulkIdsRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/bulk/organizations/divisionviews" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsBulkOrganizationsDivisionviews(body) {
		const endpointPath = "/api/v2/externalcontacts/bulk/organizations/divisionviews";
		const endpointMethod = "POST";
	 ...
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {boolean} [query.dryRun] -  If true, the request will not make any modifications, but will show you what the end result *would* be.
	 * @param {BulkOrganizationsEnrichRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/bulk/organizations/enrich" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsBulkOrganizationsEnrich(query, body) {
		const endpointPath = "/api/v2/externalcontacts/bulk/organizations/enrich";
		const endpointMethod = "POST";
	 ...
	 * @async
	 * @param {MergeContactsRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/contacts/merge" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsContactsMerge(body) {
		const endpointPath = "/api/v2/externalcontacts/contacts/merge";
		const endpointMethod = "POST";
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/scan/contacts/divisionviews/all" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getExternalcontactsScanContactsDivisionviewsAll(query) {
		const endpointPath = "/api/v2/externalcontacts/scan/contacts/divisionviews/all";
		const endpointMethod = "GET";
	 ...
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {boolean} [query.dryRun] -  If true, the request will not make any modifications, but will show you what the end result *would* be.
	 * @param {ContactEnrichRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/contacts/enrich" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsContactsEnrich(query, body) {
		const endpointPath = "/api/v2/externalcontacts/contacts/enrich";
		const endpointMethod = "POST";
	 ...
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {boolean} [query.dryRun] -  If true, the request will not make any modifications, but will show you what the end result *would* be.
	 * @param {ExternalOrganizationEnrichRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/organizations/enrich" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsOrganizationsEnrich(query, body) {
		const endpointPath = "/api/v2/externalcontacts/organizations/enrich";
		const endpointMethod = "POST";
	 ...
	 * @async
	 * @param {string} externalOrganizationId - External Organization ID
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/organizations/{externalOrganizationId}/identifiers" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getExternalcontactsOrganizationIdentifiers(externalOrganizationId) {
		const endpointPath = "/api/v2/externalcontacts/organizations/{externalOrganizationId}/identifiers";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} externalOrganizationId - External Organization ID
	 * @param {ExternalOrganizationIdentifierClaimRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/organizations/{externalOrganizationId}/identifiers" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @param {string} [query.cursor] -  Indicates where to resume query results (not required for first page), each page returns a new cursor with a 24h TTL
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/scan/organizations/divisionviews/all" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getExternalcontactsScanOrganizationsDivisionviewsAll(query) {
		const endpointPath = "/api/v2/externalcontacts/scan/organizations/divisionviews/all";
		const endpointMethod = "GET";
	 ...
	 * @param {string[]} [query.expand] -  which field, if any, to expand
	 * @param {ContactIdentifier} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/identifierlookup/contacts" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsIdentifierlookupContacts(query, body) {
		const endpointPath = "/api/v2/externalcontacts/identifierlookup/contacts";
		const endpointMethod = "POST";
	 ...
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {string[]} [query.expand] -  which field, if any, to expand
	 * @param {ExternalOrganizationIdentifier} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/identifierlookup/organizations" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsIdentifierlookupOrganizations(query, body) {
		const endpointPath = "/api/v2/externalcontacts/identifierlookup/organizations";
		const endpointMethod = "POST";
	 ...
	 * @param {string} contactId - ExternalContact ID
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {boolean} [query.includeMerged] -  Indicates whether to return segment assignments from all external contacts in the merge-set of the given one.
	 * @param {number} [query.limit] -  Number of entities to return. Default of 25, maximum of 500.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/contacts/{contactId}/journey/segments" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getExternalcontactsContactJourneySegments(contactId, query) {
		const endpointPath = "/api/v2/externalcontacts/contacts/{contactId}/journey/segments";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} contactId - ExternalContact ID
	 * @param {UpdateSegmentAssignmentRequest} [body] - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/contacts/{contactId}/journey/segments" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postExternalcontactsContactJourneySegments(contactId, body) {
		const endpointPath = "/api/v2/externalcontacts/contacts/{contactId}/journey/segments";
		const endpointMethod = "POST";
	 ...
	 * @param {string} [query.cursor] -  Indicates where to resume query results (not required for first page), each page returns a new cursor with a 24h TTL
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/scan/notes/divisionviews/all" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getExternalcontactsScanNotesDivisionviewsAll(query) {
		const endpointPath = "/api/v2/externalcontacts/scan/notes/divisionviews/all";
		const endpointMethod = "GET";
	 ...
	 * @param {string} [query.cursor] -  Indicates where to resume query results (not required for first page), each page returns a new cursor with a 24h TTL
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/scan/relationships/divisionviews/all" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getExternalcontactsScanRelationshipsDivisionviewsAll(query) {
		const endpointPath = "/api/v2/externalcontacts/scan/relationships/divisionviews/all";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {string} query.lookupVal -  User supplied value to lookup contacts (supports email addresses, e164 phone numbers, Twitter screen names)
	 * @param {string[]} [query.expand] -  which field, if any, to expand
	 * @param {string} [query.divisionId] -  Specifies which division to lookup contacts in, for the given lookup value
