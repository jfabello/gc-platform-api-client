...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.573Z
...
/**
 * @typedef {object} IgnorePhrase
 * @property {string} text - Text of the phrase to be ignored
 * @property {string} participant - Type of participant
 * @property {string} [mediaType] - Media Type for the entity (Optional)
 */
 
/**
 * @typedef {object} IgnorePhrasesRequest
 * @property {IgnorePhrase[]} phrases - List of phrases to be ignored
 */
 
/**
 * @typedef {object} IgnoreTopic
 * @property {string} text - Text of the topic to be ignored
 * @property {string} participant - Type of participant
 * @property {string} [mediaType] - Media Type for the entity (Optional)
 */
 
/**
 * @typedef {object} IgnoreTopicsRequest
 * @property {IgnoreTopic[]} topics - List of topics to be ignored
 */
 ...
 * @property {boolean} [seeding] - Flag to indicate whether seeding is supported for this miner.
...
/**
 * @typedef {object} RemoveEntitiesRequest
 * @property {RemoveEntity[]} entities - List of entities to be removed
 */
 
/**
 * @typedef {object} RemoveEntity
 * @property {string} id - Unique identifier of the entity to be removed
 */
...
class LanguageUnderstandingAPI {
	 ...
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {number} [query.pageSize] -  The page size for the listing. The max that will be returned is 200.
	 * @param {number} [query.pageNumber] -  The page number for the listing
	 * @param {string} [query.text] -  The phrase text filter applied to the listing
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignorephrases/{languageCode}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getLanguageunderstandingIgnorephrase(languageCode, query) {
		const endpointPath = "/api/v2/languageunderstanding/ignorephrases/{languageCode}";
		const endpointMethod = "GET";
		...
		if (query !== null) {
			...
			if ("text" in query && this.#checkJSONSchemaType(query["text"], "string") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "text", "string");
			}
	 ...
	 * @async
	 * @param {string} languageCode - Language Code
	 * @param {IgnorePhrasesRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignorephrases/{languageCode}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @async
	 * @param {string} languageCode - Language Code
	 * @param {RemoveEntitiesRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignorephrases/{languageCode}/remove" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postLanguageunderstandingIgnorephraseRemove(languageCode, body) {
		const endpointPath = "/api/v2/languageunderstanding/ignorephrases/{languageCode}/remove";
		const endpointMethod = "POST";
	 ...
	 * @param {number} [query.pageSize] -  The page size for the listing. The max that will be returned is 200.
	 * @param {number} [query.pageNumber] -  The page number for the listing
	 * @param {string} [query.text] -  The topic text filter applied to the listing
	 * @param {string} [query.sortOrder] -  The sort order for the listing
	 * @param {string} [query.sortBy] -  The field to sort by for the listing
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignoretopics/{languageCode}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getLanguageunderstandingIgnoretopic(languageCode, query) {
		const endpointPath = "/api/v2/languageunderstanding/ignoretopics/{languageCode}";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} languageCode - Language Code
	 * @param {IgnoreTopicsRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignoretopics/{languageCode}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @param {string} languageCode - Language Code
	 * @param {RemoveEntitiesRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/languageunderstanding/ignoretopics/{languageCode}/remove" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postLanguageunderstandingIgnoretopicRemove(languageCode, body) {
		const endpointPath = "/api/v2/languageunderstanding/ignoretopics/{languageCode}/remove";
		const endpointMethod = "POST";
