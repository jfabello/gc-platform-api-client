...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.562Z
 ...
 * @property {DiagnosticsSettings} [diagnosticsSettings] - Campaign diagnostics settings
 * @property {string} [selfUri] - The URI for this object
 */
 ...
 * @property {TimeAndDateSubCondition[]} [subConditions] - A list of sub-conditions to evaluate. Required for a timeAndDateCondition.
 * @property {boolean} [matchAnyConditions] - If true, only one sub-condition must match for the condition to be true. If false, all sub-conditions must match. Default is false. Required for a timeAndDateCondition.
 * @property {string} [timeZoneId] - The time zone to use for this condition. Required for a timeAndDateCondition.
 */
 ...
 * @property {boolean} [generateDownloadURI] - Whether to do backup export as part of Bulk Operation or not. Default: true.
 */
...
/**
 * @typedef {object} DiagnosticsSettings
 * @property {boolean} [reportLowMaxCallsPerAgentAlert] - Whether to report on low max calls per agent alerts.
 */
 ...
 * @property {string} [name]
 * @property {string} [selfUri]
 * @property {DivisionReference} [division] - The division this entity belongs to.
 */
 
/**
 * @typedef {object} DivisionReference
 * @property {string} [id] - The globally unique identifier for the object.
 * @property {string} [selfUri] - The URI for this object
 */
 ...
 * @property {UserParam[]} [userParams] - parameters to be inserted into details.
 */
 ...
 * @property {string} smsContentTemplateId - A String containing the SMS contentTemplateId.
 * @property {string} emailContentTemplateId - A String containing the Email contentTemplateId.
 */
...
/**
 * @typedef {object} TimeAndDateSubCondition
 * @property {string} [type] - The type of time/date sub-condition.
 * @property {string} [operator] - The operator to use for comparison.
 * @property {boolean} [inverted] - If true, inverts the result of evaluating this sub-condition. Default is false.
 * @property {boolean} [includeYear] - If true, includes year in date comparison for specificDate type. When false, only month and day are compared. Default is true. Only applicable for specificDate type.
 * @property {string} [thresholdValue] - Threshold value for BEFORE or AFTER operators. Format depends on type: timeOfDay: HH:mm, dayOfWeek: 1-7 (Monday-Sunday), dayOfMonth: 1-31 and/ or LAST_DAY, ODD_DAY, EVEN_DAY, specificDate: yyyy-MM-dd (if includeYear=true) or MM-dd (if includeYear=false). For single-value comparison, use a list with one element.
 * @property {TimeAndDateSubConditionRange} [range] - A range of values for BETWEEN and IN operators. Format follows the same rules as 'thresholdValue'.
 */
 
/**
 * @typedef {object} TimeAndDateSubConditionRange
 * @property {string} [min] - The minimum value of the range. Required for the operator BETWEEN. Format depends on type: timeOfDay: HH:mm, dayOfWeek: 1-7 (Monday-Sunday), dayOfMonth: 1-31, specificDate: yyyy-MM-dd (if includeYear=true) or MM-dd (if includeYear=false).
 * @property {string} [max] - The maximum value of the range. Required for the operator BETWEEN. Format follows the same rules as 'min'.
 * @property {string[]} [inSet] - A set of values that the date/ time data should be in. Required for the IN operator. Format depends on type: dayOfWeek: 1-7 (Monday-Sunday), dayOfMonth: 1-31, and/ or LAST_DAY, ODD_DAY, EVEN_DAY,specificDate: yyyy-MM-dd (if includeYear=true) or MM-dd (if includeYear=false).
 */
...
/**
 * @typedef {object} WhatsAppCampaignSchedule
 * @property {string} [id] - The globally unique identifier for the object.
 * @property {string} [name]
 * @property {string} [dateCreated] - Creation time of the entity. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 * @property {string} [dateModified] - Last modified time of the entity. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 ...
 * @property {ScheduleInterval[]} intervals - A list of intervals during which to run the associated Campaign.
 * @property {Reoccurrence[]} [recurrences] - Recurring schedules of the campaign
 * @property {string} [timeZone] - The time zone for this WhatsApp campaign schedule. Defaults to UTC if empty or not provided. See here for a list of valid time zones https://www.iana.org/time-zones
 * @property {DivisionedDomainEntityRef} whatsAppCampaign - The Campaign that this WhatsApp campaign schedule is for.
 * @property {string} [selfUri] - The URI for this object
 */
...
class OutboundAPI {
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/outbound/campaigns/performance/query" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postOutboundCampaignsPerformanceQuery(body) {
		const endpointPath = "/api/v2/outbound/campaigns/performance/query";
		const endpointMethod = "POST";
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getOutboundSchedulesWhatsappcampaign(whatsAppCampaignId) {
		const endpointPath = "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}";
		const endpointMethod = "GET";

		// Check the path parameters
		if (this.#checkJSONSchemaType(whatsAppCampaignId, "string") === false) {
			throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "whatsAppCampaignId", "string");
		}

		const apiCallOptions = {};
		apiCallOptions.pathParameters = {};
		apiCallOptions.pathParameters.whatsAppCampaignId = whatsAppCampaignId;
	 ...
	 * @async
	 * @param {string} whatsAppCampaignId - WhatsApp Campaign ID
	 * @param {WhatsAppCampaignSchedule} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @async
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/outbound/schedules/whatsappcampaigns" endpoint.
	 */
	getOutboundSchedulesWhatsappcampaigns() {
		const endpointPath = "/api/v2/outbound/schedules/whatsappcampaigns";
		const endpointMethod = "GET";
