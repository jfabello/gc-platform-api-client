...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.511Z
...
/**
 * @typedef {object} ExternalContactsSettings
 * @property {boolean} [manuallyAssignDivisionsToInteractions]
 * @property {boolean} [manuallyAssignDivisionsToContacts]
 */
...
class SettingsAPI {
	 ...
	 * Get settings
	 * @async
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/settings" endpoint.
	 */
	getExternalcontactsSettings() {
		const endpointPath = "/api/v2/externalcontacts/settings";
		const endpointMethod = "GET";
	 ...
	 * Set settings
	 * @async
	 * @param {ExternalContactsSettings} [body] - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/externalcontacts/settings" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	putExternalcontactsSettings(body) {
		const endpointPath = "/api/v2/externalcontacts/settings";
		const endpointMethod = "PUT";
