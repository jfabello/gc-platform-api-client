...
class AgentCopilotAPI {
	 ...
	 * @param {string} [query.language] -  Which language are the features supported for
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/assistants/copilot/featuresupport" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getAssistantsCopilotFeaturesupport(query) {
		const endpointPath = "/api/v2/assistants/copilot/featuresupport";
		const endpointMethod = "GET";
