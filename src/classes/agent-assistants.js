...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.537Z
...
/**
 * @typedef {object} AssistantQueueUser
 * @property {string} id - The globally unique identifier for the user.
 */
 
/**
 * @typedef {object} AssistantQueueUsersBulkAddRequest
 * @property {AssistantQueueUser[]} entities - List of users to assign assistant for. Maximum users to add is 100 per request.
 */
 
/**
 * @typedef {object} AssistantQueueUsersBulkRemoveRequest
 * @property {AssistantQueueUser[]} entities - List of users to de-assign assistant form. Maximum users to remove is 100 per request.
 */
 
/**
 * @typedef {object} AssistantQueueUsersQueryRequest
 * @property {AssistantQueueUser[]} entities - List of users to query. Maximum users to query is 100 per request.
 */
 ...
 * @property {boolean} [receiveSegmentedArticles] - Include segmented articles in knowledge suggestions.
 */
 ...
 * @property {SummarySettingEntity} [summarySetting] - Configured summary setting object.
 */
 
/**
 * @typedef {object} SummarySettingEntity
 * @property {string} [id] - The globally unique identifier for the object.
 * @property {string} [selfUri] - The URI for this object
 */
...
class AgentAssistantsAPI {
	 ...
	 * @param {string} assistantId - Assistant ID
	 * @param {string} queueId - Queue ID
	 * @param {AssistantQueueUsersBulkAddRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/assistants/{assistantId}/queues/{queueId}/users/bulk/add" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postAssistantQueueUsersBulkAdd(assistantId, queueId, body) {
		const endpointPath = "/api/v2/assistants/{assistantId}/queues/{queueId}/users/bulk/add";
	 ...
	 * @param {string} assistantId - Assistant ID
	 * @param {string} queueId - Queue ID
	 * @param {AssistantQueueUsersBulkRemoveRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/assistants/{assistantId}/queues/{queueId}/users/bulk/remove" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postAssistantQueueUsersBulkRemove(assistantId, queueId, body) {
		const endpointPath = "/api/v2/assistants/{assistantId}/queues/{queueId}/users/bulk/remove";
		const endpointMethod = "POST";
	 ...
	 * @param {string} queueId - Queue ID
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {string[]} [query.expand] -  Which fields, if any, to expand with.
	 * @param {AssistantQueueUsersQueryRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/assistants/{assistantId}/queues/{queueId}/users/query" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postAssistantQueueUsersQuery(assistantId, queueId, query, body) {
		const endpointPath = "/api/v2/assistants/{assistantId}/queues/{queueId}/users/query";
		const endpointMethod = "POST";
