...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.579Z
 ...
 * @property {IgnoredActivityCodeIds} [ignoredActivityCodeIds] - Activity code IDs that should be ignored for adherence purposes
 */
...
/**
 * @typedef {object} AgentMuScheduleQuery
 * @property {string} startDate - The start date for the range to query the schedule's for the agent's management unit. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 * @property {string} endDate - The end date for the range to query the schedule's for the agent's management unit. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 */
 ...
 * @property {string} id - The ID of the forecast
 * @property {string} weekDate - The weekDate of the short term forecast in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {string} [description] - The description of the short term forecast
 * @property {number} weekNumber - The week number to be used from the selected forecast. First week starts with number 1
 * @property {string} [selfUri] - The URI for this object
 */
 ...
 * @property {boolean} [autoPublishApprovedTimeOffRequests] - Whether newly approved time-off requests with activity codes associated with this time-off plan should be automatically published to the schedule
 * @property {SetWrapperString} [restrictedActivityCodeIds] - The IDs of non time-off activity codes to check for conflicts in case the auto approval rule specifies checking activity codes. If these activity codes are present in schedule and overlap with the time-off request duration, the request will not be auto approved
...
/**
 * @typedef {object} CapacityPlanDeleteRequest
 * @property {string[]} capacityPlanIds - The IDs of the capacity plans to be deleted
 */
 
/**
 * @typedef {object} CapacityPlanMetadata
 * @property {UserReference} modifiedBy - The user who modified the entity
 * @property {string} modifiedDate - The entity last modified date. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 * @property {string} [createdDate] - The date the entity created. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
 * @property {UserReference} [createdBy] - The user who created the associated entity
 * @property {number} version - The version of the capacity plan
 */
 
/**
 * @typedef {object} CapacityPlanRequest
 * @property {string} name - The name of the capacity plan
 * @property {string} [description] - Description of the capacity plan
 * @property {string} startBusinessUnitDate - The start date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {string} endBusinessUnitDate - The end date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {BuShortTermForecastReference} forecast - The selected forecast for this capacity plan. Null when main forecast is used in the future
 * @property {number} fullTimeEquivalentWeeklyHours - The weekly hours used to calculate full time equivalent agents
 * @property {CreateStaffingGroupAllocation[]} staffingGroupAllocations - List of staffing group allocations to be used for the capacity plan
 */
...
/**
 * @typedef {object} CopyCapacityPlanRequest
 * @property {string} name - The name of the new capacity plan
 * @property {string} [description] - Description of the new capacity plan
 * @property {string} startBusinessUnitDate - The start date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {string} endBusinessUnitDate - The end date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {ValueWrapperBuShortTermForecastReference} [forecast] - The selected forecast for this capacity plan. Uses forecast from original capacity plan if not specified
 */
 ...
 * @property {string[]} [planningGroupIds] - The planning group IDs associated with this activity code
 */
...
/**
 * @typedef {object} CreateCapacityPlanStaffingGroupMetricChangeRequest
 * @property {number} numberOfWeeks - The number of weeks to which the metric change applies
 * @property {number} weekStartNumber - The start number of the week (starting from 1) to which the metric change applies, related to numberOfWeeks
 * @property {number} value - The value of the metric
 * @property {string} metric - The metric which is going to be modified for the selected staffing groups
 * @property {string} [notes] - Notes about the staffing groups metric changes
 * @property {string[]} staffingGroupIds - The IDs of the staffing groups affected by the metric change
 * @property {number} version - The version of the capacity plan
 */
...
/**
 * @typedef {object} CreateStaffingGroupAllocation
 * @property {string} staffingGroupId - The ID of the staffing group used in this capacity plan
 * @property {number} initialShrinkagePercentage - The shrinkage percentage of the staffing group that can be used for all weeks in the planning period, in the scale of 0 - 100
 * @property {number} initialAttritionPercentage - The attrition percentage of the staffing group that can be used for all weeks in the planning period, in the scale of 0 - 100
 * @property {number} startingWeeklyFullTimeEquivalentCount - The weekly count of full time equivalent agents in the staffing group that can be used for the first week of the planning period
 */
 ...
 * @property {string[]} [planningGroupIds] - The set of planning group IDs to associate with the staffing group
 */
 ...
 * @property {boolean} [constrainMaximumWorkingWeekendsPerPlanningPeriod] - Whether to constrain the maximum working weekends in the planning period
 * @property {number} [maximumWorkingWeekendsPerPlanningPeriod] - Maximum working weekends in the planning period
 ...
 * @property {PlanningPeriodShiftConstraints} [planningPeriodConstraints] - Planning period constraints
...
/**
 * @typedef {object} IgnoredActivityCodeIds
 * @property {string[]} [values] - List of activity code IDs
 */
...
/**
 * @typedef {object} PlanningPeriodShiftConstraints
 * @property {boolean} [enabled] - Whether shifts per planning period is enabled. This field is non-nullable on the response
 * @property {number} [minimumCount] - The minimum number of shifts required per planning period. This field is non-nullable on the response
 * @property {number} [maximumCount] - The maximum number of shifts allowed per planning period. This field is non-nullable on the response
 */
...
/**
 * @typedef {object} QueryCapacityPlanStaffingGroupMetricChangeHistory
 * @property {string[]} staffingGroupIds - The IDs of the staffing groups for which to fetch the metric change history
 * @property {string} [queryEndDate] - Fetch the history of metric changes on or before this date, in IS0-8601 format. If not specified, sets to current date
 */
 
/**
 * @typedef {object} QueryPlanningGroupToStaffingGroupsRequest
 * @property {string[]} [planningGroupIds] - The list of planning group IDs to request capacity group associations
 * @property {string[]} [staffingGroupIds] - The list of staffing group IDs to request capacity group associations
 */
 ...
 * @property {string} [activityCodeId] - The ID of the activity code by which to filter the affected limit objects. Required if timeOffLimitId is not specified
 ...
 * @property {string} [activityCodeIdReplacement] - The ID of the activity code with which to replace activities belonging to the original category if applicable (required if action == Replace, must be a default activity code ID)
 */
 
/**
 * @typedef {object} ShiftTradeExternalActivityRule
 * @property {string} externalActivityType - The external activity type to which to apply this rule
 * @property {string} action - The action this rule invokes
 * @property {string} [activityCodeIdReplacement] - The ID of the activity code with which to replace to replace external activities (required if action == KeepWithAgent, must be a default activity code ID)
 */
 ...
 * @property {ShiftTradeExternalActivityRule[]} [externalActivityRules] - Rules that specify what to do with external activities that are part of a shift
 * @property {boolean} [externalActivityRuleIgnoresActivityCategoryRule] - Whether external activity rules ignore activity category rules
 * @property {number} [maxTradeSpanWeeks] - The maximum number of weeks a shift trade can span
 * @property {number} [maxTradesPerAgentPerWeek] - The maximum number of shift trades an agent can submit per week
 * @property {number} [minMinutesBetweenShifts] - The minimum number of minutes between shifts
 * @property {string} [planningPeriodMinPaidViolations] - How to handle shift trades which result in violations of planning period minimum paid time constraint
 * @property {string} [planningPeriodMaxPaidViolations] - How to handle shift trades which result in violations of planning period maximum paid time constraint
 * @property {string} [minMinutesBetweenShiftsViolations] - How to handle shift trades which result in violations of minimum number of minutes between shifts constraint
 */
 ...
 * @property {string} [submissionRangeType] - The type of the submission range
 ...
 * @property {ValueWrapperLocalDate} [submissionLatestDate] - The latest date for the time off request submission interpreted in the business unit time zone in yyyy-MM-dd format
 */
 ...
 * @property {ListWrapperString} [planningGroupIds] - The planning group IDs associated with this activity code
...
/**
 * @typedef {object} UpdateCapacityPlanRequest
 * @property {string} [name] - The name of the capacity plan
 * @property {string} [description] - Description of the capacity plan
 * @property {string} [startBusinessUnitDate] - The start date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {string} [endBusinessUnitDate] - The end date for the capacity plan relative to the business unit time zone in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 * @property {ValueWrapperBuShortTermForecastReference} [forecast] - The selected forecast for this capacity plan
 * @property {number} [fullTimeEquivalentWeeklyHours] - The weekly hours used to calculate full time equivalent agents
 * @property {boolean} [useLatestPlanningGroupStaffingGroupAssociation] - Whether to use latest staffing group to planning group association
 * @property {CapacityPlanMetadata} metadata - The metadata of this capacity plan
 */
 ...
 * @property {SetWrapperString} [planningGroupIds] - The set of planning group Ids to associate with the staffing group
...
/**
 * @typedef {object} ValueWrapperBuShortTermForecastReference
 * @property {BuShortTermForecastReference} [value] - The value for the associated field
 */
...
/**
 * @typedef {object} ValueWrapperLocalDate
 * @property {string} [value] - The value for the associated field. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
 */
...
/**
 * @typedef {object} WfmHistoricalAdherenceQueryForAgent
 * @property {string} startDate - Beginning of the date range to query in ISO-8601 format
 * @property {string} [endDate] - End of the date range to query in ISO-8601 format. If it is not set, end date will be set to current time
 * @property {string} [timeZone] - The time zone, in olson format, to use in defining days when computing adherence. The results will be returned as UTC timestamps regardless of the time zone input.
 */
...
class WorkforceManagementAPI {
	 ...
	 * @param {string[]} [query.expand] -  Expand to include minimum staffing values in (staffing requirement response or applied to base staffing requirement values)
	 ...
	 * @param {boolean} [query.includeSchedulingDefaultMessageSeverities] -  Whether to include scheduling default message severities
	...
	getWorkforcemanagementBusinessunit(businessUnitId, query) {
		...
		if (query !== null) {
			...
			if ("includeSchedulingDefaultMessageSeverities" in query && this.#checkJSONSchemaType(query["includeSchedulingDefaultMessageSeverities"], "boolean") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "includeSchedulingDefaultMessageSeverities", "boolean");
			}
		}
	 ...
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	patchWorkforcemanagementBusinessunit(businessUnitId, query, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}";
		const endpointMethod = "PATCH";
	 ...
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunits(query, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits";
		const endpointMethod = "POST";
	 ...
	 * @async
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {QueryPlanningGroupToStaffingGroupsRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/planninggroups/query" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitStaffinggroupsPlanninggroupsQuery(businessUnitId, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/staffinggroups/planninggroups/query";
		const endpointMethod = "POST";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {boolean} [query.forceDownloadService] -  Force the result of this operation to be sent via download service
	 ...
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitStaffinggroupsQuery(businessUnitId, query, body) {
	 ...
	 * @param {boolean} [query.includeCrossWeekShifts] -  Whether to include all shift trades with either the initiating shift or the receiving shift in the week
	 * @param {boolean} [query.forceDownloadService] -  Force the result of this operation to be sent via download service. For testing/app development purposes
	...
	getWorkforcemanagementManagementunitWeekShifttrades(managementUnitId, weekDateId, query) {
		...
		if (query !== null) {
			...
			if ("includeCrossWeekShifts" in query && this.#checkJSONSchemaType(query["includeCrossWeekShifts"], "boolean") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "includeCrossWeekShifts", "boolean");
			}
			if ("forceDownloadService" in query && this.#checkJSONSchemaType(query["forceDownloadService"], "boolean") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "forceDownloadService", "boolean");
			}
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs/{jobId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementAgentsMeAdherenceHistoricalJob(jobId) {
		const endpointPath = "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs/{jobId}";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {string[]} [query.expand] -  Which fields, if any, to expand with. wfm:AgentHistoricalAdherenceConformance:view permission is required for conformance, and wfm:agentSchedule:view permission is required for scheduledActivities.
	 * @param {WfmHistoricalAdherenceQueryForAgent} [body] - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementAgentsMeAdherenceHistoricalJobs(query, body) {
		const endpointPath = "/api/v2/workforcemanagement/agents/me/adherence/historical/jobs";
		const endpointMethod = "POST";
	 ...
	 * @async
	 * @param {string} teamId - The ID of the team
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/teams/{teamId}/adherence" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementTeamAdherence(teamId) {
		const endpointPath = "/api/v2/workforcemanagement/teams/{teamId}/adherence";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} businessUnitId - The ID of the business unit
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementBusinessunitCapacityplans(businessUnitId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans";
		const endpointMethod = "GET";
	 ...
	 * @async
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {CapacityPlanRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementBusinessunitCapacityplan(businessUnitId, capacityPlanId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}";
		const endpointMethod = "GET";
		...
		if (this.#checkJSONSchemaType(capacityPlanId, "string") === false) {
			throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "capacityPlanId", "string");
		}

		const apiCallOptions = {};
		apiCallOptions.pathParameters = {};
		apiCallOptions.pathParameters.businessUnitId = businessUnitId;
		apiCallOptions.pathParameters.capacityPlanId = capacityPlanId;
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @param {UpdateCapacityPlanRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @async
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {CapacityPlanDeleteRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/bulk/remove" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitCapacityplansBulkRemove(businessUnitId, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/bulk/remove";
		const endpointMethod = "POST";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocations(businessUnitId, capacityPlanId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations";
		const endpointMethod = "GET";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @param {CreateCapacityPlanStaffingGroupMetricChangeRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocations" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffingrequirements" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementBusinessunitCapacityplanStaffingrequirements(businessUnitId, capacityPlanId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffingrequirements";
		const endpointMethod = "GET";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @param {CopyCapacityPlanRequest} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/copy" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitCapacityplanCopy(businessUnitId, capacityPlanId, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/copy";
		const endpointMethod = "POST";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/requirement/generate" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitCapacityplanRequirementGenerate(businessUnitId, capacityPlanId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/requirement/generate";
		const endpointMethod = "POST";
	 ...
	 * @param {string} businessUnitId - The ID of the business unit
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @param {QueryCapacityPlanStaffingGroupMetricChangeHistory} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory/query" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistoryQuery(businessUnitId, capacityPlanId, body) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory/query";
		const endpointMethod = "POST";
	 ...
	 * @param {string} capacityPlanId - The ID of the capacity plan
	 * @param {object} query - The query string parameters for the request. An empty object or null is allowed if all query string parameters are optional.
	 * @param {string} [query.beforeDateId] -  The date to delete records that are created on or before this date in yyyy-MM-dd format. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	deleteWorkforcemanagementBusinessunitCapacityplanStaffinggroupallocationshistory(businessUnitId, capacityPlanId, query) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplans/{capacityPlanId}/staffinggroupallocationshistory";
		const endpointMethod = "DELETE";
		...
		if (query !== null) {
			if ("beforeDateId" in query && this.#checkJSONSchemaType(query["beforeDateId"], "string") === false) {
				throw new errors.ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID(endpointPath, endpointMethod, "beforeDateId", "string");
			}
		}
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	getWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecast(businessUnitId, weekDateId, forecastId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}";
		const endpointMethod = "GET";
	 ...
	 * @param {string} weekDateId - weekDateId of forecast, format yyyy-MM-dd. Dates are represented as an ISO-8601 string. For example: yyyy-MM-dd
	 * @param {string} forecastId - forecastId of forecast
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}/forceregenerate" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_PATH_PARAMETER_TYPE_INVALID} If a path parameter argument is not of the proper type.
	 */
	postWorkforcemanagementBusinessunitCapacityplanningLongtermrequirementsAutomaticbestmethodWeekForecastForceregenerate(businessUnitId, weekDateId, forecastId) {
		const endpointPath = "/api/v2/workforcemanagement/businessunits/{businessUnitId}/capacityplanning/longtermrequirements/automaticbestmethod/weeks/{weekDateId}/forecasts/{forecastId}/forceregenerate";
		const endpointMethod = "POST";
	 ...
	 * @param {boolean} [query.forceAsync] -  Force the result of this operation to be sent asynchronously via notification. For testing/app development purposes
	 * @param {boolean} [query.forceDownloadService] -  Force the result of this operation to be sent via download service. For testing/app development purposes
	 * @param {AgentMuScheduleQuery} body - The body of the request. An empty object or null is allowed if the body is optional.
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/workforcemanagement/agentschedules/managementunits/mine" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_REQUEST_BODY_TYPE_INVALID} If the request body argument is not of the proper type.
	 */
	postWorkforcemanagementAgentschedulesManagementunitsMine(query, body) {
		const endpointPath = "/api/v2/workforcemanagement/agentschedules/managementunits/mine";
		const endpointMethod = "POST";
