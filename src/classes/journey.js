...
// This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.529Z
 ...
 * @property {string} [imageAltText] - Image description text for accessibility compliance and assistive technology support.
 */
 ...
 * @property {number} estimatedCompletionMargin - Margin of error of the estimated time of completion
...
class JourneyAPI {
	 ...
	 * @returns {Promise<HTTPResponse>} A promise that settles to the HTTP response of the call to the "/api/v2/journey/views/jobs/me" endpoint.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETERS_TYPE_INVALID} If the query string parameters argument is not of the proper type.
	 * @throws {ERROR_GC_PLATFORM_API_CLIENT_API_CALL_QUERY_PARAMETER_TYPE_INVALID} If a query string parameter is not of the proper type.
	 */
	getJourneyViewsJobsMe(query) {
		const endpointPath = "/api/v2/journey/views/jobs/me";
		const endpointMethod = "GET";
