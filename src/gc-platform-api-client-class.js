...
// The following section was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.612Z
...
import { AIStudioAPI } from "./classes/aistudio.js";
...
import { BusinessRulesAPI } from "./classes/business-rules.js";
...
class GCPlatformAPIClient {
	...
	#AIStudioAPI = new AIStudioAPI(this);
	...
	#BusinessRulesAPI = new BusinessRulesAPI(this);
	...
	/**
	 * Read-only property that returns the AIStudio API class.
	 * @readonly
	 * @type {AIStudioAPI}
	 */
	get AIStudioAPI() {
		return this.#AIStudioAPI;
	}
	...
	/**
	 * Read-only property that returns the BusinessRules API class.
	 * @readonly
	 * @type {BusinessRulesAPI}
	 */
	get BusinessRulesAPI() {
		return this.#BusinessRulesAPI;
	}
