...
- [`getUserrecordingMedia`](#getuserrecordingmedia) - Download a user recording.
...
- `query.async` - **(boolean, optional)** When set to true, api will return 202 response until the recording is ready for download
