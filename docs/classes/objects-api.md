...
- `query.pageSize` - **(string, optional)** Page size (max 200, default 25)
- `query.id` - **(string[], optional)** Optionally request specific divisions by their IDs
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.619Z*