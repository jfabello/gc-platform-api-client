# `ScreenRecordingAPI` Class

Screen recording with background assistant

## Methods

- [`postScreenrecordingToken`](#postscreenrecordingtoken) - Sign identifying information for screen recording
...
- `body` - **([ScreenRecordingUserAuthenticatedInfo](../definitions/screenrecordinguserauthenticatedinfo-definition.md), optional)** - The body of the request. An empty object or `null` is allowed if the body is optional.
