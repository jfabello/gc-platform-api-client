...
- [`deleteDiagnosticsLogcaptureBrowserUser`](#deletediagnosticslogcapturebrowseruser) - Disable browser log capture for the user
- [`getDiagnosticsLogcaptureBrowserEntriesDownloadJob`](#getdiagnosticslogcapturebrowserentriesdownloadjob) - Gets status of async download execution
- [`getDiagnosticsLogcaptureBrowserUser`](#getdiagnosticslogcapturebrowseruser) - Get log capture configuration for the user
- [`getDiagnosticsLogcaptureBrowserUsers`](#getdiagnosticslogcapturebrowserusers) - Get all log capture enabled users for an org
- [`postDiagnosticsLogcaptureBrowserEntriesDownloadJobs`](#postdiagnosticslogcapturebrowserentriesdownloadjobs) - Creates an async download execution
- [`postDiagnosticsLogcaptureBrowserEntriesQuery`](#postdiagnosticslogcapturebrowserentriesquery) - Query collected log entries. It returns a limited amount of records, to get all records use download endpoint.
- [`postDiagnosticsLogcaptureBrowserUser`](#postdiagnosticslogcapturebrowseruser) - Enable log capture for a user or update expiration
...
- `userId` - **(string, required)** The id of the user to disable browser log capture
...
|---|---|---|
| `204` |  | Browser log capture successfully disabled for the user |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LogCaptureDownloadExecutionResponse](../definitions/logcapturedownloadexecutionresponse-definition.md) | successful operation |
| `202` | [LogCaptureDownloadExecutionResponse](../definitions/logcapturedownloadexecutionresponse-definition.md) | In progress - Download execution is in progress. |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `userId` - **(string, required)** The id of the user to get browser log capture configuration
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LogCaptureUserConfigurationResponse](../definitions/logcaptureuserconfigurationresponse-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query.includeExpired` - **(boolean, optional)** Include expired users with log captures still available for search or download
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LogCaptureUserConfigurationListing](../definitions/logcaptureuserconfigurationlisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `body` - **([LogCaptureQueryRequest](../definitions/logcapturequeryrequest-definition.md), optional)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
|---|---|---|
| `200` | [LogCaptureDownloadExecutionResponse](../definitions/logcapturedownloadexecutionresponse-definition.md) | successful operation |
| `202` | [LogCaptureDownloadExecutionResponse](../definitions/logcapturedownloadexecutionresponse-definition.md) | Accepted - Download execution is accepted. |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LogCaptureQueryResponse](../definitions/logcapturequeryresponse-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `userId` - **(string, required)** The id of the user to enable browser log capture
- `body` - **([LogCaptureUserConfiguration](../definitions/logcaptureuserconfiguration-definition.md), optional)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LogCaptureUserConfiguration](../definitions/logcaptureuserconfiguration-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
