...
- [`getDownload`](#getdownload) - Issues a redirect to a signed secure download URL for specified download
...
- `downloadId` - **(string, required)** Download ID
...
- `query.contentDisposition` - **(string, optional)** 
- `query.issueRedirect` - **(boolean, optional)** 
- `query.redirectToAuth` - **(boolean, optional)** 
...
|---|---|---|
| `200` | [UrlResponse](../definitions/urlresponse-definition.md) | successful operation |
