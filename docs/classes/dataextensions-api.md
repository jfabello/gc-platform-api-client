# `DataExtensionsAPI` Class

Data extensions

## Methods

- [`getDataextensionsCoretype`](#getdataextensionscoretype) - Get a specific named core type.
- [`getDataextensionsCoretypes`](#getdataextensionscoretypes) - Get the core types from which all schemas are built.
- [`getDataextensionsLimits`](#getdataextensionslimits) - Get quantitative limits on schemas
...
- `coretypeName` - **(string, required)** The core type's name
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.390Z*