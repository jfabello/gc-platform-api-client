...
- `body` - **([CopyVoicemailMessage](../definitions/copyvoicemailmessage-definition.md), optional)** - The body of the request. An empty object or `null` is allowed if the body is optional.
