...
- `query.botId` - **(string[], optional)** Bot IDs. Maximum of 50
- `query.virtualAgentEnabled` - **(boolean, optional)** Include or exclude virtual agent flows, only applies to GenesysBotFlows or GenesysDigitalBotFlows
- `query.pageSize` - **(number, optional)** The maximum results to return. Maximum of 100
