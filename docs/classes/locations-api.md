...
- [`getLocation`](#getlocation) - Get Location by ID.
- [`getLocations`](#getlocations) - Get a list of all locations.
- [`getLocationsSearch`](#getlocationssearch) - Search locations using the q64 value returned from a previous search
- [`getLocationSublocations`](#getlocationsublocations) - Get sublocations for location ID.
- [`patchLocation`](#patchlocation) - Update a location
- [`postLocations`](#postlocations) - Create a location
...
|---|---|---|
| `204` |  | The location was deleted successfully |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LocationDefinition](../definitions/locationdefinition-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [LocationEntityListing](../definitions/locationentitylisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `locationId` - **(string, required)** Location ID
- `body` - **([LocationUpdateDefinition](../definitions/locationupdatedefinition-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `body` - **([LocationCreateDefinition](../definitions/locationcreatedefinition-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.402Z*