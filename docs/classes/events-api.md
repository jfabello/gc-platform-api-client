...
- [`postEventsConversations`](#posteventsconversations) - Publish Conversation Batch Events
- [`postEventsUsersPresence`](#posteventsuserspresence) - Publish User Presence Status Batch Events
- [`postEventsUsersRoutingstatus`](#posteventsusersroutingstatus) - Publish Agent Routing Status Batch Events
...
- `body` - **([BatchConversationEventRequest](../definitions/batchconversationeventrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
|---|---|---|
| `200` | [BatchEventResponse](../definitions/batcheventresponse-definition.md) | successful operation |
...
- `body` - **([BatchUserPresenceEventRequest](../definitions/batchuserpresenceeventrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `body` - **([BatchUserRoutingStatusEventRequest](../definitions/batchuserroutingstatuseventrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.337Z*