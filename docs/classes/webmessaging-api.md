# `WebMessagingAPI` Class

Web messaging

## Methods

- [`deleteWebmessagingDeploymentPushdevice`](#deletewebmessagingdeploymentpushdevice) - Delete device information
- [`getWebmessagingMessages`](#getwebmessagingmessages) - Get the messages for a web messaging session.
- [`patchWebmessagingDeploymentPushdevice`](#patchwebmessagingdeploymentpushdevice) - Edit device information
- [`postWebmessagingDeploymentPushdevice`](#postwebmessagingdeploymentpushdevice) - Add a new device information
...
- `tokenId` - **(string, required)** Device token id or cookie id
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [WebMessagingMessageEntityList](../definitions/webmessagingmessageentitylist-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `deploymentId` - **(string, required)** WebMessaging deployment id
- `tokenId` - **(string, required)** Device token id or cookie id
- `body` - **([PushDeviceUpdateRequest](../definitions/pushdeviceupdaterequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `deploymentId` - **(string, required)** WebMessaging deployment id
- `tokenId` - **(string, required)** Device token id or cookie id
- `body` - **([PushDeviceInsertRequest](../definitions/pushdeviceinsertrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `204` |  | Device created successfully |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
