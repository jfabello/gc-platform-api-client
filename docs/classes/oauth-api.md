...
- [`deleteOauthClient`](#deleteoauthclient) - Delete OAuth Client
- [`getOauthAuthorization`](#getoauthauthorization) - Get a client that is authorized by the resource owner
- [`getOauthAuthorizations`](#getoauthauthorizations) - List clients that have been authorized, requested, or revoked by the resource owner
- [`getOauthClient`](#getoauthclient) - Get OAuth Client
- [`getOauthClients`](#getoauthclients) - The list of OAuth clients
- [`getOauthClientUsageQueryResult`](#getoauthclientusagequeryresult) - Get the results of a usage query
- [`getOauthClientUsageSummary`](#getoauthclientusagesummary) - Get a summary of OAuth client API usage
- [`getOauthScope`](#getoauthscope) - An OAuth scope
- [`getOauthScopes`](#getoauthscopes) - The list of OAuth scopes
- [`postOauthClients`](#postoauthclients) - Create OAuth client
- [`postOauthClientSecret`](#postoauthclientsecret) - Regenerate Client Secret
- [`postOauthClientUsageQuery`](#postoauthclientusagequery) - Query for OAuth client API usage
- [`putOauthClient`](#putoauthclient) - Update OAuth Client
...
- `clientId` - **(string, required)** The ID of client
- `headers` - **(object)** The headers to include in the request. An empty object or `null` is allowed if all headers are optional.
- `headers.Accept-Language` - **(string, optional)** The language in which to display the client descriptions.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthAuthorization](../definitions/oauthauthorization-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthAuthorizationListing](../definitions/oauthauthorizationlisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthClient](../definitions/oauthclient-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthClientEntityListing](../definitions/oauthcliententitylisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `executionId` - **(string, required)** ID of the query execution
- `clientId` - **(string, required)** Client ID
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [ApiUsageQueryResult](../definitions/apiusagequeryresult-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query.days` - **(string, optional)** Previous number of days to query
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [UsageExecutionResult](../definitions/usageexecutionresult-definition.md) | successful operation |
| `202` | [UsageExecutionResult](../definitions/usageexecutionresult-definition.md) | Execution not completed, check back for results |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `scopeId` - **(string, required)** Scope ID
- `headers` - **(object)** The headers to include in the request. An empty object or `null` is allowed if all headers are optional.
- `headers.Accept-Language` - **(string, optional)** The language with which to display the scope description.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthScope](../definitions/oauthscope-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `headers` - **(object)** The headers to include in the request. An empty object or `null` is allowed if all headers are optional.
- `headers.Accept-Language` - **(string, optional)** The language with which to display the scope descriptions.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [OAuthScopeListing](../definitions/oauthscopelisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `body` - **([OAuthClientRequest](../definitions/oauthclientrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `clientId` - **(string, required)** Client ID
- `body` - **([ApiUsageClientQuery](../definitions/apiusageclientquery-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
