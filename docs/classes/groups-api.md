...
- [`deleteGroupMembers`](#deletegroupmembers) - Remove members
- [`getFieldconfig`](#getfieldconfig) - Fetch field config for an entity type
- [`getGroup`](#getgroup) - Get group
- [`getGroupIndividuals`](#getgroupindividuals) - Get all individuals associated with the group
- [`getGroupMembers`](#getgroupmembers) - Get group members, includes individuals, owners, and dynamically included people
- [`getGroupProfile`](#getgroupprofile) - Get group profile
- [`getGroups`](#getgroups) - Get a group list
- [`getGroupsSearch`](#getgroupssearch) - Search groups using the q64 value returned from a previous search
- [`getProfilesGroups`](#getprofilesgroups) - Get group profile listing
- [`postGroupMembers`](#postgroupmembers) - Add members
- [`postGroups`](#postgroups) - Create a group
- [`postGroupsSearch`](#postgroupssearch) - Search groups
- [`putGroup`](#putgroup) - Update group
...
- `query.ids` - **(string, required)** Comma separated list of userIds to remove. A maximum of 50 members are allowed per request.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `202` | [Empty](../definitions/empty-definition.md) | Success, group membership was updated |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [Group](../definitions/group-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query` - **(object)** The query string parameters for the request. An empty object or `null` is allowed if all query string parameters are optional.
- `query.fields` - **(string, optional)** Comma separated fields to return.  Allowable values can be found by querying /api/v2/fieldconfig?type=group and using the key for the elements returned by the fieldList
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [GroupProfile](../definitions/groupprofile-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [GroupEntityListing](../definitions/groupentitylisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [GroupProfileEntityListing](../definitions/groupprofileentitylisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `groupId` - **(string, required)** Group ID
- `body` - **([GroupMembersUpdate](../definitions/groupmembersupdate-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `body` - **([GroupCreate](../definitions/groupcreate-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `groupId` - **(string, required)** Group ID
- `body` - **([GroupUpdate](../definitions/groupupdate-definition.md), optional)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.401Z*