...
- [`deleteAssistantQueue`](#deleteassistantqueue) - Disassociate a queue from an assistant.
- [`deleteAssistantQueues`](#deleteassistantqueues) - Disassociate the queues from an assistant for the given assistant ID and queue IDs.
- [`getAssistant`](#getassistant) - Get an assistant.
- [`getAssistantQueue`](#getassistantqueue) - Get queue Information for an assistant.
- [`getAssistantQueues`](#getassistantqueues) - Get all the queues associated with an assistant.
- [`getAssistants`](#getassistants) - Get all assistants.
- [`getAssistantsQueues`](#getassistantsqueues) - Get all queues assigned to any assistant.
- [`patchAssistant`](#patchassistant) - Update an assistant.
- [`patchAssistantQueues`](#patchassistantqueues) - Update Queues for an Assistant.
- [`postAssistants`](#postassistants) - Create an Assistant.
- [`putAssistantQueue`](#putassistantqueue) - Create a queue assistant association.
...
- `query.queueIds` - **(string, optional)** Comma-separated identifiers of the queues that need to be deleted.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [Assistant](../definitions/assistant-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [AssistantQueueListing](../definitions/assistantqueuelisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query.pageSize` - **(string, optional)** Number of entities to return. Maximum of 200.
- `query.name` - **(string, optional)** Return the assistant by the given name.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [AssistantListing](../definitions/assistantlisting-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query.after` - **(string, optional)** The cursor that points to the end of the set of entities that has been returned.
- `query.pageSize` - **(string, optional)** Number of entities to return. Maximum of 200.
- `query.queueIds` - **(string, optional)** Comma-separated identifiers of the queues that need to be retrieved.
- `query.expand` - **(string, optional)** Which fields, if any, to expand.
...
- `assistantId` - **(string, required)** Assistant ID
- `body` - **([Assistant](../definitions/assistant-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
- `assistantId` - **(string, required)** Assistant ID
- `body` - **([AssistantQueue[]](../definitions/assistantqueue-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
|---|---|---|
| `200` | [AssistantQueue](../definitions/assistantqueue-definition.md) | successful operation |
| `201` | [AssistantQueue](../definitions/assistantqueue-definition.md) | Created |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
