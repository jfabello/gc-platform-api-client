...
- [`getTelephonyMediaregions`](#gettelephonymediaregions) - Retrieve the list of AWS regions media can stream through.
- [`getTelephonySipmessagesConversation`](#gettelephonysipmessagesconversation) - Get a SIP message.
- [`getTelephonySipmessagesConversationHeaders`](#gettelephonysipmessagesconversationheaders) - Get SIP headers.
- [`getTelephonySiptraces`](#gettelephonysiptraces) - Fetch SIP metadata
- [`getTelephonySiptracesDownloadDownloadId`](#gettelephonysiptracesdownloaddownloadid) - Get signed S3 URL for a pcap download
- [`postTelephonySiptracesDownload`](#posttelephonysiptracesdownload) - Request a download of a pcap file to S3
...
|---|---|---|
| `200` | [MediaRegions](../definitions/mediaregions-definition.md) | successful operation |
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [Callmessage](../definitions/callmessage-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query.keys` - **(string[], optional)** comma-separated list of header identifiers to query. e.g. ruri,to,from
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [Callheader](../definitions/callheader-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `query` - **(object)** The query string parameters for the request. An empty object or `null` is allowed if all query string parameters are optional.
- `query.callId` - **(string, optional)** unique identification of the placed call
- `query.toUser` - **(string, optional)** User to who the call was placed
- `query.fromUser` - **(string, optional)** user who placed the call
- `query.conversationId` - **(string, optional)** Unique identification of the conversation
- `query.dateStart` - **(string, required)** Start date of the search. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
- `query.dateEnd` - **(string, required)** End date of the search. Date time is represented as an ISO-8601 string. For example: yyyy-MM-ddTHH:mm:ss[.mmm]Z
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [SipSearchResult](../definitions/sipsearchresult-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `downloadId` - **(string, required)** unique id for the downloaded file in S3
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [SignedUrlResponse](../definitions/signedurlresponse-definition.md) | successful operation |
| `202` | [SignedUrlResponse](../definitions/signedurlresponse-definition.md) | Request to download pcap file has been accepted |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
- `body` - **([SIPSearchPublicRequest](../definitions/sipsearchpublicrequest-definition.md), required)** - The body of the request. An empty object or `null` is allowed if the body is optional.
...
| HTTP Status Code | Returned type | Description |
|---|---|---|
| `200` | [SipDownloadResponse](../definitions/sipdownloadresponse-definition.md) | successful operation |
| `400` | [ErrorBody](../definitions/errorbody-definition.md) | The request could not be understood by the server due to malformed syntax. |
| `401` | [ErrorBody](../definitions/errorbody-definition.md) | No authentication bearer token specified in authorization header. |
| `403` | [ErrorBody](../definitions/errorbody-definition.md) | You are not authorized to perform the requested action. |
| `404` | [ErrorBody](../definitions/errorbody-definition.md) | The requested resource was not found. |
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-04-24T15:04:25.433Z*