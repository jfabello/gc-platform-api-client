# `WhatsAppIntegrationRequest` Definition
...
| wabaCertificate | `string` | Yes | The waba(WhatsApp Business Manager) certificate associated to the WhatsApp integration phone number |
