...
| startPhoneNumber | `string` | Yes | The starting phone number for the range of this DID pool. Must be in E.164 format |
| endPhoneNumber | `string` | Yes | The ending phone number for the range of this DID pool. Must be in E.164 format |
| comments | `string` | No |  |
| provider | `string` | No | The provider for this DID pool |
