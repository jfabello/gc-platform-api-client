# `KnowledgeDocumentSearchVariation` Definition
...
| chunks | [`DocumentVariationSearchChunkBlock[]`](documentvariationsearchchunkblock-definition.md) | No | The chunk blocks associated with the variation. |
