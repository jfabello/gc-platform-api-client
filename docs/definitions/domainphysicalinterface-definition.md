# `DomainPhysicalInterface` Definition
...
| hardwareAddress | `string` | No |  |
| portLabel | `string` | No |  |
| physicalCapabilities | [`DomainPhysicalCapabilities`](domainphysicalcapabilities-definition.md) | No |  |
