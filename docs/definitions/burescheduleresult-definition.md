...
| headcountForecast | [`BuHeadcountForecastBuPlanningGroupHeadcountForecastResult`](buheadcountforecastbuplanninggroupheadcountforecastresult-definition.md) | No | The headcount forecast. Note the result will always be delivered via the headcountForecastDownloadUrl; however the schema is included for documentation |
