# `BulkResponseResultExternalContactExternalContactBulkEntityErrorExternalContact` Definition
...
| error | [`BulkEntityErrorExternalContact`](bulkentityerrorexternalcontact-definition.md) | No | An error describing why this Bulk operation failed. Only returned on failure. |
