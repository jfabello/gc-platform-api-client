# `WhatsAppCampaignSchedule` Definition
...
| timeZone | `string` | No | The time zone for this WhatsApp campaign schedule. Defaults to UTC if empty or not provided. See here for a list of valid time zones https://www.iana.org/time-zones |
| whatsAppCampaign | [`DivisionedDomainEntityRef`](divisioneddomainentityref-definition.md) | Yes | The Campaign that this WhatsApp campaign schedule is for. |
