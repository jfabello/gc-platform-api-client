...
| number | `string` | No |  |
| owner | [`DomainEntityRef`](domainentityref-definition.md) | No | A Uri reference to the owner of this extension, which is either a User or an IVR |
| extensionPool | [`DomainEntityRef`](domainentityref-definition.md) | No |  |
| ownerType | `string` | No |  |
