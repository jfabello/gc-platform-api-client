...
| enabled | `boolean` | No | True if an emergency is occurring and the associated emergency call flow(s) should be used.  False otherwise. |
| emergencyCallFlows | [`EmergencyCallFlow[]`](emergencycallflow-definition.md) | No | The emergency call flow(s) to use during an emergency. |
