...
| template | [`DomainEntityRef`](domainentityref-definition.md) | No | The station base/template. (Deprecated - Please use the lineBaseSettings field instead, as it contains the same data) |
| site | [`DomainEntityRef`](domainentityref-definition.md) | No |  |
| lineBaseSettings | [`DomainEntityRef`](domainentityref-definition.md) | No | The station base/template. |
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.995Z*