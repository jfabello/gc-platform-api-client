# `EvaluationAggregationQuery` Definition
...
| filter | [`EvaluationAggregateQueryFilter`](evaluationaggregatequeryfilter-definition.md) | No | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters |
...
| views | [`EvaluationAggregationView[]`](evaluationaggregationview-definition.md) | No | Custom derived metric views |
