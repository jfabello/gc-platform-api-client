...
| workPlanId | [`ValueWrapperString`](valuewrapperstring-definition.md) | No | The ID of the work plan for which the work plan shift emanates from |
| workPlanShiftId | [`ValueWrapperString`](valuewrapperstring-definition.md) | No | The ID of the work plan shift that was used in schedule generation |
