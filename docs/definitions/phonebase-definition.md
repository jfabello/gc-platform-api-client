...
| phoneMetaBase | [`DomainEntityRef`](domainentityref-definition.md) | Yes | A phone metabase is essentially a database for storing phone configuration settings, which simplifies the configuration process. |
| lines | [`LineBase[]`](linebase-definition.md) | Yes | The list of linebases associated with the phone base. |
