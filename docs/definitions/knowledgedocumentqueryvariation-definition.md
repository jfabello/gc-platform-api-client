# `KnowledgeDocumentQueryVariation` Definition
...
| chunks | [`DocumentVariationQueryChunkBlock[]`](documentvariationquerychunkblock-definition.md) | No | The chunk blocks associated with the variation. |
