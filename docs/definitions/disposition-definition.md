...
| amdTimeout | [`DispositionAmdTimeout`](dispositionamdtimeout-definition.md) | No | Answering Machine Detection timeout configuration. |
| silentCallTimeout | [`DispositionSilentCallTimeout`](dispositionsilentcalltimeout-definition.md) | No | Silent Call timeout configuration. |
