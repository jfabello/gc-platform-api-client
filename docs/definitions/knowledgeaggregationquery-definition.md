# `KnowledgeAggregationQuery` Definition
...
| filter | [`KnowledgeAggregateQueryFilter`](knowledgeaggregatequeryfilter-definition.md) | No | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters |
...
| views | [`KnowledgeAggregationView[]`](knowledgeaggregationview-definition.md) | No | Custom derived metric views |
...
| sortMetric | [`KnowledgeAggregationSort`](knowledgeaggregationsort-definition.md) | No | Required when requesting multiple metrics. Only applicable for topN/bottomN query type. |
