...
| multipleSelectQuestionOptionScores | [`EvaluationQuestionScore[]`](evaluationquestionscore-definition.md) | No | Only applicable to Multiple Select questions. Scores corresponding to the options of Multiple Select questions. |
