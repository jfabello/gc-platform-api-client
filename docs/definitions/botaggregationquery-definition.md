# `BotAggregationQuery` Definition
...
| filter | [`BotAggregateQueryFilter`](botaggregatequeryfilter-definition.md) | No | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters |
...
| views | [`BotAggregationView[]`](botaggregationview-definition.md) | No | Custom derived metric views |
...
*This file was automatically generated by the Generate Genesys Cloud Platform API classes utility on 2025-11-26T23:43:17.713Z*