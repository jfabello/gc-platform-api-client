# `TaskManagementAggregationQuery` Definition
...
| filter | [`TaskManagementAggregateQueryFilter`](taskmanagementaggregatequeryfilter-definition.md) | No | Behaves like a SQL WHERE clause. This is ANDed with the interval parameter. Expresses boolean logical predicates as well as dimensional filters |
...
| views | [`TaskManagementAggregationView[]`](taskmanagementaggregationview-definition.md) | No | Custom derived metric views |
