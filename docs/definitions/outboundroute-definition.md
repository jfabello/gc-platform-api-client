...
| site | [`Site`](site-definition.md) | No | The site associated to the outbound route. |
| managed | `boolean` | No | Is this outbound route being managed remotely. |
