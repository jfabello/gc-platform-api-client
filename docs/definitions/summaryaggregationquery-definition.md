# `SummaryAggregationQuery` Definition
...
| sortMetric | [`SummaryAggregationSort`](summaryaggregationsort-definition.md) | No | Required when requesting multiple metrics. Only applicable for topN/bottomN query type. |
